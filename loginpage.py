...
class Login_System:
    def __init__(self,root):
        ...
        #*************All image************
        self.bg_icon=ImageTk.PhotoImage(file="images/2.jpg")
        self.user_icon=PhotoImage(file="images/icon.png")
        self.pass_icon=PhotoImage(file="images/pass.png")
        self.logo_icon=PhotoImage(file="images/loco.png")
    ...
    def login(self):
        ...
        elif self.uname.get()=="Jaiswal" and self.pass_.get()=="123456":
